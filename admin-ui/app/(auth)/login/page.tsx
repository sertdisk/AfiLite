/* Kısa açıklama: Login sayfası — email ve şifre ile giriş formu gönderir, backend yanıtına göre yönlendirir. */
'use client';

import { useState } from 'react';

export default function LoginPage() {
  // Not: Basit form state'leri. Üretimde form yönetimi ve validasyon geliştirilebilir.
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="w-full max-w-sm bg-white rounded-lg shadow p-6">
        ...
        {/* Açıklama: Email ve parola alanları zorunludur. */}
