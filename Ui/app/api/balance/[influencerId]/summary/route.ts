// Proxy: /api/balance/[influencerId]/summary → backend /api/v1/balance/:influencerId/summary (GET)
...
function extractInfluencerId(req: NextRequest): string | null {
  ...
  // /api/balance/[influencerId]/summary yolundan influencerId'yi al
  // parts = ['api', 'balance', '21', 'summary'] -> parts[2] = '21'
  return parts.length >= 3 ? parts[2] : null;
}

// GET /api/balance/[influencerId]/summary → backend GET /api/v1/balance/:influencerId/summary
export async function GET(req: NextRequest) {
  try {
    ...
    console.log(`[Proxy] GET /api/balance/${influencerId}/summary -> Backend URL: ${url}`);
    ...
    const message = err?.message || 'Proxy sırasında beklenmeyen bir hata oluştu (GET /api/balance/[influencerId]/summary)';
